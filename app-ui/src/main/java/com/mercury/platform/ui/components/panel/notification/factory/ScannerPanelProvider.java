...
public class ScannerPanelProvider extends NotificationPanelProvider<NotificationDescriptor,ScannerPanelController> {
    @Override
    ...
    @Override
    protected NotificationPanel<NotificationDescriptor, ScannerPanelController> getPanel() {
