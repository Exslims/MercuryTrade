...
public class AppThemeColor {
    ...
    public static final Color BORDER_GREEN = new Color(20, 113, 122);
    ...
    public static final Color INC_PANEL_ARROW = new Color(111, 173, 39);
    public static final Color OUT_PANEL_ARROW = new Color(0, 156, 222);
    ...
    public static final Color ADR_PANEL_BORDER = new Color(70, 81, 80);
