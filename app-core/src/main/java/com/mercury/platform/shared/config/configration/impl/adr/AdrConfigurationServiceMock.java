...
public class AdrConfigurationServiceMock extends BaseConfigurationService<List<AdrProfileDescriptor>> implements ListConfigurationService<AdrProfileDescriptor>{
    ...
    public List<AdrProfileDescriptor> getDefault() {
        ...
        AdrIconGroupDescriptor groupDescriptor = new AdrIconGroupDescriptor(new Dimension(64,64), new Point(400,400));
        ...
        AdrIconGroupDescriptor groupDescriptor1 = new AdrIconGroupDescriptor(new Dimension(64,64), new Point(500,500));;
        ...
        profile.setContents(Arrays.asList(
                new AdrComponentWrapper(AdrComponentType.ICON_GROUP,groupDescriptor),
                new AdrComponentWrapper(AdrComponentType.ICON_GROUP,groupDescriptor1),
                new AdrComponentWrapper(AdrComponentType.ICON,new AdrIconDescriptor("Granite_Flask",new Point(400,400),new Dimension(64,64),4f))));
