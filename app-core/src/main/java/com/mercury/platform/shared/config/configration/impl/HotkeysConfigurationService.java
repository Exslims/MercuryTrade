...
public class HotkeysConfigurationService extends BaseConfigurationService<Map<String,HotKeyDescriptor>> implements KeyValueConfigurationService<String,HotKeyDescriptor> {
    ...
    public Map<String, HotKeyDescriptor> getDefault() {
        ...
        keyMap.put(HotKeyType.TRADE_PLAYER.name(),new HotKeyDescriptor(GlobalKeyEvent.VK_1,'2',true,false,false,false));
        keyMap.put(HotKeyType.KICK_PLAYER.name(),new HotKeyDescriptor(GlobalKeyEvent.VK_1,'3',true,false,false,false));
        keyMap.put(HotKeyType.STILL_INTERESTING.name(),new HotKeyDescriptor(GlobalKeyEvent.VK_1,'4',true,false,false,false));
        keyMap.put(HotKeyType.CLOSE_NOTIFICATION.name(),new HotKeyDescriptor(GlobalKeyEvent.VK_1,'5',true,false,false,false));
